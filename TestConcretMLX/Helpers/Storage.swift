...
final class Storage {
    enum File: String, CaseIterable {
        ...
        case matrixPrivateKey = "concretePrivateKey" // DataVault Only
        case matrixCPUCompressionKey = "concreteCPUCompressionKey" // Public
        case matrixEncryptedProfile = "concreteProfile.fheencrypted" // Public
        case matrixEncryptedResult = "concreteResult.fheencrypted" // Public
